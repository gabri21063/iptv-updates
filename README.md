...
[![Download](https://img.shields.io/badge/Download-APK-v225-red)](https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk)

---

## 🇮🇹 ITALIANO

### ✨ Novità principali (v217–v225)
...
- **📡 Network Quality Monitor (v225)**: overlay in tempo reale con banda stimata (Mbps), bitrate/corrente video, risoluzione e salute buffer. Alert automatico "Connessione lenta — qualità adattata" quando la linea degrada. Cap qualità configurabile per risparmiare banda (impostazione `nqm_max_mbps`).
- **⚡ Bassa latenza WebRTC (v225)**: canali sport/interattivi a **<1s di latenza** via WebRTC/WHEP nel web player (pulsante ⚡). Integrazione MediaMTX automatica — vedi sezione dedicata sotto.
...
1. Scarica l'APK: [IPTVPlayer-v225.apk](https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk)
...
- **📡 Network Quality Monitor (v225)**: real-time overlay with estimated bandwidth (Mbps), current video bitrate, resolution and buffer health. Automatic "Slow connection — quality adapted" alert when the line degrades. Configurable quality cap to save bandwidth (`nqm_max_mbps`).
- **⚡ WebRTC ultra-low latency (v225)**: sports/interactive channels at **<1s latency** via WebRTC/WHEP in the web player (⚡ button). Automatic MediaMTX integration — see dedicated section below.
...
### 📥 Install / Update
1. Download the APK: [IPTVPlayer-v225.apk](https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk)
...
- **📡 Netzwerk-Qualitätsmonitor (v225)**: Echtzeit-Overlay mit geschätzter Bandbreite (Mbps), aktuellem Video-Bitraten, Auflösung und Pufferzustand. Automatischer Alert "Langsame Verbindung — Qualität angepasst" bei absinkender Leitung. Konfigurierbare Qualitätsgrenze zur Bandbreitenersparnis (`nqm_max_mbps`).
- **⚡ WebRTC Ultra-Niedriglatenz (v225)**: Sport-/Interaktivkanäle mit **<1s Latenz** via WebRTC/WHEP im Web Player (⚡-Taste). Automatische MediaMTX-Integration — siehe Abschnitt unten.
...
### 📥 Installation / Update
1. APK herunterladen: [IPTVPlayer-v225.apk](https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk)
2. Android TV/Box: **Downloader**-App → Code `2140263`
...
### ✨ Nouvelles fonctionnalités (v217–v225)
...
- **📡 Moniteur de qualité réseau (v225)** : superposition en temps réel avec bande passante estimée (Mbps), débit vidéo actuel, résolution et santé du tampon. Alerte automatique "Connexion lente — qualité adaptée" lorsque la ligne se dégrade. Limite de qualité configurable pour économiser la bande passante (`nqm_max_mbps`).
- **⚡ Basse latence WebRTC (v225)** : chaînes sport/interactives à **<1s de latence** via WebRTC/WHEP dans le lecteur web (bouton ⚡). Intégration automatique MediaMTX — voir la section dédiée ci-dessous.
...
1. Téléchargez l'APK : [IPTVPlayer-v225.apk](https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk)
2. Android TV/Box : app **Downloader** → Code `2140263`
...
- 📥 APK: `https://github.com/gabri21063/iptv-updates/releases/download/v225/IPTVPlayer-v225.apk`
